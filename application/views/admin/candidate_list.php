                    ...
                    <div class="form-box">
                        ...
                        <form enctype="multipart/form-data" id="compReg_form">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="email" type="email" name="Email" autocomplete="off" value="">
                                <span class="error_flag" id="email_err"></span>
                            </div>
                            <div class="form-group">
                                <label for="mob_no">Mobile Number</label>
                                <input class="form-control" id="mob_no" type="mob_no" name="mob_no" autocomplete="off" value="">
                                <span class="error_flag" id="mob_err"></span>
                            </div>
                            <div class="col-md-12 row">
                                <div class="col-md-10">
                                   <div class="form-group all_remv">
                                        <label for="email_ids">Company domain name email ids(Min=1 to Max=5 )</label>
                                        <input type="text" class="form-control" id="email_ids" name="email_ids[]"  placeholder="Enter email id" autocomplete="off" value="">
                                    </div>
                                </div>
                                <div class="col-md-2">
