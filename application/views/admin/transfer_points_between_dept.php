                ...
                <div class=" container-fluid container">
                    <h1>Transfer Points Between Department</h1>
                    <div class="form-box">

                        <form enctype="multipart/form-data" id="compReg_form">
                            <div class="form-group">
                                <label for="comp_name">From Department Name</label>
                                <select class="form-control" id="from_dept_name" type="text" name="from_dept_name"  autocomplete="off">
                                  <option value="---">Select From Department Name</option>
                            ...
                            <div class="form-group">
                                <label for="comp_name">To Department Name</label>
                                <select class="form-control" id="to_dept_name" type="text" name="to_dept_name"  autocomplete="off">
                                  <option value="---">Select To Department Name</option>
                                  <!-- <option value="HR">HR</option>
                                  <option value="Production">Production</option>
                                  <option value="Support">Support</option>
                                  <option value="Account">Account</option> -->
    ...
    <script type="text/javascript">
        ...
        $('#from_dept_name').select2({
            ajax: {
              url: 'get_DepartmentList',
              dataType: 'json',
